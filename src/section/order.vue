<template>
  <div id="order" class="order relative text-center">
    <div class="order-section">
      <!-- Title -->
      <div class="title_box">
        <img class="img_title" src="./form/title.svg" />
        <HR class="hr" :props-color="'255,255,255'" />
        <img class="img_subtitle" src="./form/en.svg" />
        ...
        <div class="flex gap-2 items-center control policy">
          ...
          <p class="text-[#000]">
            本人知悉並同意<label for="policy-modal"
              class="modal-button text-[#283ccb] cursor-pointer hover:opacity-70">「個資告知事項聲明」</label>內容
          </p>
        </div>
        <Policy />

        <!-- Recaptcha -->
        <vue-recaptcha class="flex justify-center z-10 recaptcha" ref="recaptcha" :sitekey="info.recaptcha_site_key_v2"
